...
let list = [
  ...
  "hex", (module PipeHex.Make : Pipe.PIPE_FORMAT), "Like 'human', but char are additionally separated by spaces and all non-printable chars printed in hex (for debugging)";
